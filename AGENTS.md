...
- Version compatibility-owned network protocols and serialized formats by compatibility changes, independently of the mod release; follow the [integration contract](.agents/skills/maintain-ysm-epicfight-integration/references/integration-contract.md).
