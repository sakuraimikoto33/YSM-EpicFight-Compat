...
Require-Text 'gradle.properties' '^ysm_mapping_api_version=0\.1\.2$' 'Mapping API selection version must remain 0.1.2.'
Require-Text 'gradle.properties' '^ysm_mapping_api_version_range=0\.1\.2$' 'Mapping API loader dependency floor must remain 0.1.2.'
...
[pscustomobject]@{
    success = $true
    target = $branch
    mappingApiVersion = '0.1.2'
    mappingApiVersionRange = '0.1.2'
